...
class User(UserMixin, db.Model):
    ...
    def followed_queries(self):
        followed = Sparql.query.join(
            followers, (followers.c.followed_id == Sparql.user_id)).filter(
                followers.c.follower_id == self.id)
        return followed.union(self.queries).order_by(Sparql.timestamp.desc())
